...
export const DataTable: FC<DataTableProps> = ({
    ...
    return (
        <div className="relative flex flex-col h-full w-full">
            <div className=" w-inherit md:w-[calc(100%-60px)] box-border flex flex-col bg-[#FFF8E1] py-3 overflow-auto sm:m-7 m-2.5 border border-[#FFE082] rounded-md  h-[calc(100% - 550px)]">
                <div className="px-3">
